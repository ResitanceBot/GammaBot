...
get_filename_component(_filename "/home/husarion/rosbot-pr-ws/src/rosbot_ekf/srv/Configuration.srv" NAME_WE)
add_custom_target(_rosbot_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosbot_ekf" "/home/husarion/rosbot-pr-ws/src/rosbot_ekf/srv/Configuration.srv" ""
)
...
_generate_srv_cpp(rosbot_ekf
  "/home/husarion/rosbot-pr-ws/src/rosbot_ekf/srv/Configuration.srv"
  "${MSG_I_FLAGS}"
  ""
